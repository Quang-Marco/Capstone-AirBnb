...
const RegisterPage = () => {
  ...
  return (
    <Container
      sectionName="registerPage"
      backgroundImage="https://static.independent.co.uk/2022/05/12/12/Airbnb-Stay-Japan.jpg"
    >
      <div className="registerOverlay">
        ...
        <form onSubmit={handleSubmit}>
          <div className="lg:flex lg:flex-wrap">
            ...
            <button
              type="submit"
              className="py-2 my-3 bg-[#F1295D] text-white font-bold border-none rounded-md w-full"
            >
              Signup
            </button>
          </div>
