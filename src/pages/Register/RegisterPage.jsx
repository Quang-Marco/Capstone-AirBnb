...
import registerBg from "../../assets/img/bg-register.jpg";
...
const RegisterPage = () => {
  ...
  return (
    ...
    >
      <div className="registerOverlay px-4 lg:mx-60">
        <div className="flex justify-center border-b-2 gap-5 ">
          <Link to={pathDefault.homePage} className="my-auto">
            <svg width="102" height="32" className="backToHomePage">
              <path
          ...
          <div className="lg:flex lg:flex-wrap">
            ...
            <div className="p-2 lg:w-1/2 lg:px-5 lg:pb-5">
              ...
              {errors.gender && touched.gender ? (
                <p className="text-sm italic text-red-500 lg:text-base">
                  {errors.gender}
                </p>
              ) : null}
            </div>
            <button
              type="submit"
              className="py-2 my-6 bg-[#F1295D] text-white font-bold border-none rounded-md w-full hover:bg-[#FD365B] hover:scale-[1.005] transition duration-300 ease-in-out"
            >
              Sign up
            </button>
