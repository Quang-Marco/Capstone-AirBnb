  ...
  const tabs = [
    {
      ...
      content: (
        <form
          ...
          className="text-gray-600 border md:w-[900px] rounded-full shadow-sm hover:shadow-md duration-300 cursor-pointer"
        >
          <div className="grid grid-cols-4 sm:grid-cols-6 items-center text-sm">
            <div className="sm:col-span-2 px-2 sm:px-6 py-2 sm:py-4 rounded-full flex items-center justify-between hover:bg-gray-100 duration-300">
              <Dropdown
                menu={{
                  items: itemsLocation,
                }}
              ...
              <button
                ...
                className={`w-6 h-6 flex justify-center items-center rounded-full hover:bg-gray-300 duration-300 ${
                  searchValue ? "" : "hidden"
                }`}
              >
            ...
            >
              <div>
                <p className="text-xs sm:text-sm font-semibold">Check in</p>
            ...
            >
              <div>
                <p className="text-xs sm:text-sm font-semibold">Check out</p>
                <p className="text-xs sm:text-sm">{dates.checkout}</p>
              </div>
            </CustomDropdown>
            <div className="sm:col-span-2 pl-2 sm:pl-6 pr-2 rounded-full flex items-center justify-between hover:bg-gray-100 duration-300">
              <CustomDropdown
                items={itemsGuest}
                classContent="-left-56 sm:left-0"
              >
                <div className="sm:w-52">
                  <p className="text-xs sm:text-sm font-semibold">Who</p>
    ...
    },
    {
      ...
      content: (
        <form
          ...
          className="text-gray-600 border w-full md:w-[900px] rounded-full shadow-sm hover:shadow-md duration-300 cursor-pointer"
        >
